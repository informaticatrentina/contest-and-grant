 ...
 */
define('BASE_URL','www.aggregator.com');
 ...
 */
define('IDENTITY_MANAGER_API_URL', 'http://10.0.1.103:8001/v1/');
 ...
 */
define('CONTEST_ADMIN_USERS', '["santosh@incaendo.com", "rahul@incaendo.com"]');
